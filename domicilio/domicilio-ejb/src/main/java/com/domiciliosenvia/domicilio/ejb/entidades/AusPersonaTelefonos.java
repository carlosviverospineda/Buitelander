...
public class AusPersonaTelefonos implements Serializable {
    ...
    public AusPersonaTelefonos(Integer id, int numero, String usuarioCrea, String terminalCrea, Date fechaHoraCrea) {
        this.id = id;
        this.numero = numero;
    ...
    public String toString() {
        return "com.domiciliosenvia.domicilio.ejb.entidades.AusPersonaTelefonos[ id=" + id + " ]";
    }
