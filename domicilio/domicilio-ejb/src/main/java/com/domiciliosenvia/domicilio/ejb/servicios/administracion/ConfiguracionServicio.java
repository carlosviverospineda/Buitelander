...
import com.domiciliosenvia.domicilio.ejb.entidades.GnConfiguraciones;
...
public class ConfiguracionServicio extends GenericoServicio implements ConfiguracionRemoto {
    ...
    @Override
    public List<GnConfiguracionObj> consultarLista(ParamConsulta paramConsulta) throws Exception {
        List<GnConfiguracionObj> listResult = new ArrayList();
        try {
    ...
    @Override
    public GnConfiguracionObj consultar(int id) throws Exception {
        GnConfiguracionObj objRes = null;
        try {
    ...
    @Override
    public int insertar(GnConfiguracionObj obj) throws Exception {
        int _id = 0;
        try {
    ...
    @Override
    public void actualizar(GnConfiguracionObj obj) throws Exception {
        try {
    ...
    public static GnConfiguracionObj castEntidadNegocio(GnConfiguraciones ent) {
        GnConfiguracionObj obj = new GnConfiguracionObj();
        obj.setId(ent.getId());
    ...
    public static GnConfiguraciones castNegocioEntidad(GnConfiguracionObj obj) {
