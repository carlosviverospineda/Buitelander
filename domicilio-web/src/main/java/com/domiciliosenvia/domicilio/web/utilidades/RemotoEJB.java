...
//            props.put(Context.SECURITY_PRINCIPAL, "domicilio");
//            props.put(Context.SECURITY_CREDENTIALS, "domicilio");
//            props.put("jboss.naming.client.ejb.context", true);
            Context context = new InitialContext(props);
            String preContext = "ejb:domicilio-ear/domicilio-ejb-1.0-SNAPSHOT//";
