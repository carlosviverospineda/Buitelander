...
import com.domiciliosenvia.domicilio.web.administracion.servicio.LogServicioImpl;
import com.domiciliosenvia.domicilio.web.utilidades.Url;
import java.util.List;
import javax.annotation.PostConstruct;
import javax.faces.bean.ManagedBean;
import javax.faces.bean.ViewScoped;
import com.domiciliosenvia.domicilio.web.administracion.servicio.LogServicioIface;
...
public class LogBean extends Url{
    ...
    public LogBean() {
        ...
        if (_mod == null) {
            ...
            lazyLog = new LazyDataModel<Log>() {
                ...
                @Override
                public List<Log> load(int primerRegistro, int registrosPagina, String orden, SortOrder formaOrden, Map<String, FilterMeta> filtros) {
    ...
    public LogServicioIface getLogServicio() {
        if(logServicio==null)logServicio=new LogServicioImpl();
        return logServicio;
    }
