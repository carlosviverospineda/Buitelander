...
import com.domiciliosenvia.domicilio.web.administracion.servicio.UbicacionServicioImpl;
...
//        this.padres = new ArrayList();
        ...
        if (_mod == null) {
            ...
            lazyUbicacion = new LazyDataModel<Ubicacion>() {
                ...
                @Override
                public List<Ubicacion> load(int primerRegistro, int registrosPagina, String orden, SortOrder formaOrden, Map<String, FilterMeta> filtros) {
                ...
                @Override
                public Object getRowKey(Ubicacion objeto) {
                    return objeto.getId();
                }
    ...
    public UbicacionServicioImpl getUbicacionServicio() {
        if (ubicacionServicio == null) {
            ubicacionServicio = new UbicacionServicioImpl();
        }
    ...
    public List<Ubicacion> listarPorTipo(int tipo, int profundidad) {
        return getUbicacionServicio().consultarPorTipo(tipo, profundidad);
    }
