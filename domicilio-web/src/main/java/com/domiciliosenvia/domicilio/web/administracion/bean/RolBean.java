...
import com.domiciliosenvia.domicilio.web.administracion.servicio.RolServicioIface;
import com.domiciliosenvia.domicilio.web.administracion.servicio.RolServicioImpl;
    ...
    public RolBean() {
        ...
        if (_mod == null) {
            ...
            lazyRol = new LazyDataModel<Rol>() {
                ...
                @Override
                public List<Rol> load(int primerRegistro, int registrosPagina, String orden, SortOrder formaOrden, Map<String, FilterMeta> filtros) {
                ...
                @Override
                public Object getRowKey(Rol objeto) {
                    return objeto.getId();
                }
