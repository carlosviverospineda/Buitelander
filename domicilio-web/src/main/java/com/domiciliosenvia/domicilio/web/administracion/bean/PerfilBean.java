...
import com.domiciliosenvia.domicilio.web.administracion.servicio.PerfilServicioImpl;
...
import com.domiciliosenvia.domicilio.web.administracion.servicio.PerfilServicioIface;
    ...
    public PerfilBean() {
        ...
        if (_mod == null) {
            ...
            lazyPerfil = new LazyDataModel<Perfil>() {
                ...
                @Override
                public List<Perfil> load(int primerRegistro, int registrosPagina, String orden, SortOrder formaOrden, Map<String, FilterMeta> filtros) {
                ...
                @Override
                public Object getRowKey(Perfil objeto) {
                    return objeto.getId();
                }
