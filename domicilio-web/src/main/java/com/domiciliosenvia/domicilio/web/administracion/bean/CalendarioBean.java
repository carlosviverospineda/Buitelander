...
import com.domiciliosenvia.domicilio.utilidades.DateUtils;
import com.domiciliosenvia.domicilio.web.administracion.servicio.CalendarioServicioIface;
import com.domiciliosenvia.domicilio.web.administracion.servicio.CalendarioServicioImpl;
        ...
        lazyEventModel = new LazyScheduleModel() {
            ...
            public void loadEvents(LocalDateTime start, LocalDateTime end) {
                ...
                for (DiaHabil obj : getRegistros()) {
                    DefaultScheduleEvent event = new DefaultScheduleEvent("", DateUtils.asLocalDateTime(obj.getFecha()), DateUtils.asLocalDateTime(obj.getFecha()), true);
