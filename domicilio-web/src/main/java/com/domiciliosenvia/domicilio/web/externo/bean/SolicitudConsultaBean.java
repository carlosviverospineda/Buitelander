package com.domiciliosenvia.domicilio.web.externo.bean;
...
//
//                @Override
//                public List<GsSolicitud> load(int primerRegistro, int registrosPagina, String orden, SortOrder formaOrden, Map<String, FilterMeta> filtros) {
...
//
//                @Override
//                public Object getRowKey(GsSolicitud vendedor) {
