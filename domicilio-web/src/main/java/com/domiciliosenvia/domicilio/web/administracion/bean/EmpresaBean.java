...
import com.domiciliosenvia.domicilio.web.administracion.servicio.EmpresaServicioIface;
    ...
    public EmpresaBean() {
        ...
        if (_mod == null) {
            ...
            lazyEmpresa = new LazyDataModel<Empresa>() {
                ...
                @Override
                public List<Empresa> load(int primerRegistro, int registrosPagina, String orden, SortOrder formaOrden, Map<String, FilterMeta> filtros) {
                ...
                @Override
                public Object getRowKey(Empresa objeto) {
                    return objeto.getId();
                }
...
//
//            @Override
//            public List<CntPrestador> load(int primerRegistro, int registrosPagina, String orden, SortOrder formaOrden, Map<String, FilterMeta> filtros) {
//                getParamConsulta2().setPrimerRegistro(primerRegistro);
//                getParamConsulta2().setRegistrosPagina(registrosPagina);
//                getParamConsulta2().setOrden(orden);
//                getParamConsulta2().setAscendente(SortOrder.ASCENDING.equals(formaOrden));
...
//
//            @Override
//            public Object getRowKey(CntPrestador ips) {
//                return ips.getId();
//            }
//
//            @Override
