...
import com.domiciliosenvia.domicilio.web.administracion.servicio.ModuloServicioImpl;
...
import com.domiciliosenvia.domicilio.web.administracion.servicio.ModuloServicioIface;
...
public class ModuloBean extends Url {
    ...
    public void crearVersion(int id) {
        ...
        lazyModuloVersion = new LazyDataModel<ModuloVersion>() {
            ...
            @Override
            public List<ModuloVersion> load(int primerRegistro, int registrosPagina, String orden, SortOrder formaOrden, Map<String, FilterMeta> filtros) {
            ...
            @Override
            public Object getRowKey(ModuloVersion moduloVersion) {
                return moduloVersion.getId();
            }
    ...
    public void crearManual(int id, String nombre) {
        ...
        lazyManual = new LazyDataModel<ModuloManual>() {
            ...
            @Override
            public List<ModuloManual> load(int primerRegistro, int registrosPagina, String orden, SortOrder formaOrden, Map<String, FilterMeta> filtros) {
                //usamos el mismo getParamConsulta pero validamos si debemos cambiarlo

                getParamConsultaManual().setPrimerRegistro(primerRegistro);
                getParamConsultaManual().setRegistrosPagina(registrosPagina);
                getParamConsultaManual().setOrden(orden);
                getParamConsultaManual().setAscendente(SortOrder.ASCENDING.equals(formaOrden));
                HashMap<String, Object> filtrosHash = CompatibilidadPF.ConvertirFiltroMetaToHash(filtros);
            ...
            @Override
            public Object getRowKey(ModuloManual moduloManual) {
                return moduloManual.getId();
            }
