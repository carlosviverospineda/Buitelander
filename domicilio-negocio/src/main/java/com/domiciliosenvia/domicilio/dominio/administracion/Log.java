...
public class Log extends Auditoria {
    ...
    public Log(String accion, String modulo, String descripcion, Date fechaHora, String ipPublica, String ipPrivada, String empresaEjecucion, String usuario, String empresaUsuario) {
        this.accion = accion;
        this.modulo = modulo;
    ...
    public String toString() {
        return "Log{" + "id=" + id + ", accion=" + accion + ", modulo=" + modulo + ", descripcion=" + descripcion + ", fechaHora=" + fechaHora + ", ipPublica=" + ipPublica + ", ipPrivada=" + ipPrivada + ", empresaEjecucion=" + empresaEjecucion + ", usuario=" + usuario + ", empresaUsuario=" + empresaUsuario + '}';
    }
